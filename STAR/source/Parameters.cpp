...
void Parameters::inputParameters (int argInN, char* argIn[], JNIEnv * env, jobjectArray r1, jobjectArray r2) {//input parameters: default, from files, from command line
