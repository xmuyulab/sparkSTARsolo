...
* The FASTA and GTF files, for one of the older releases:
    ...
    ./STAR  --runMode genomeGenerate --runThreadN 32 --genomeDir /home/liuyu/solo/index --genomeFastaFiles /mnt/spark/dataset/GRCh38.p12.genome.fa  --sjdbGTFfile /mnt/spark/dataset/gencode.v31.annotation.gtf
    ```
